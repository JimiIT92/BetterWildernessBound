...
Anyone can contribute to Better Wilderness Bound, suggesting their ideas [using the Feature Request module](https://github.com/JimiIT92/BetterWildernessBound/issues/new?assignees=JimiIT92&labels=enhancement&template=feature_request.md&title=)
...
You can download Better Wilderness Bound on [CurseForge](https://www.curseforge.com/minecraft/mc-mods/hendrixs-better-wilderness-bound) or [Modrinth](https://modrinth.com/mod/hendrixs-better-wilderness-bound/versions).

**I will post new releases only there**.

Any other websites that offers you Better Wilderness Bound shouldn't be trusted and should be reported immediately (as they could be a scam and contain malicious software)!

-------------------------
### 🍺 Support the project

Developing and maintaining Better Wilderness Bound, requires a lot of time and effort,
but after all I really enjoy doing this ❤

Better Wilderness Bound is, and **<ins>always</ins>** will be, **<ins>FREE TO USE</ins>**.

If someone asked you some money to download Better Wilderness Bound, I am afraid to tell you that you got scammed! 😥
...
I hope you enjoy Better Wilderness Bound as much as I enjoy develop new ideas and content for it,
and let me know if there are any issues on the [issue tracker](https://github.com/JimiIT92/BetterWildernessBound/issues/new?assignees=JimiIT92&labels=enhancement&template=bug_report.md&title=).
